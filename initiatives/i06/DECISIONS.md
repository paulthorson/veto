...
The standing plan reserves final approval of these numbers to the operator plus
...
**What changes this.** the operator and/or the independent framework reviewer
...
not the operator's approval — it is a documented provisional default so the
initiative does not block on a future-dated human gate. Only the human can
